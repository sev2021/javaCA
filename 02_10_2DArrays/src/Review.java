...
public class Review {
	public static void main(String[] args) {  
		 ...
		 * The rows will represent the student and the columns will represent the exam number. 
		 ...
		 * and -1 for the remaining exams. Use the provided print statement to print the result in the console.
		 */
  ...
  System.out.println(Arrays.deepToString(scores));
	...
	/* The next set of exams have occurred. Using 4 lines of code, 
	 * manually enter the scores (89.7, 90.5, 93.6, 88.1) for the second exam (column 1). 
   ...
   * to contribute towards their scores. For all exam grades less than 90, 
